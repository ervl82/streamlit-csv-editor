...
def mappa_causali(tratt_fiscale_series, mappa_df):
    ...
    Usa le colonne 'Trattamento' e 'Codice' come nel file mappa_causali.csv.
    Se non trova corrispondenza, restituisce stringa vuota.
    """
    mappa_dict = dict(zip(mappa_df['Trattamento'], mappa_df['Codice']))
...
def convert_coverflex(df, codice_azienda, mappa_causali_df):
    ...
    df_out["Codice voce"] = "WELF01"  # codice voce fisso
    df_out["Descrizione"] = ""
    df_out["Quantità"] = ""
    df_out["Base"] = ""
...
def convert_doubleyou(df, codice_azienda, mappa_causali_df):
    ...
    df_out["Codice voce"] = "WELF02"  # codice voce fisso
    df_out["Descrizione"] = ""
    df_out["Quantità"] = ""
    df_out["Base"] = ""
